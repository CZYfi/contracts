...
contract LPFarming is Context, Ownable {
    ...
    constructor(address treasury) {
        ...
        _claimPeriodForCZYReward = 201600; // around 7 days, could be changed by governance
        _claimPeriodForSwapReward = 201600; // around 7 days, could be changed by governance

        _allocPointForCZYReward = 8000; // 80% of reward will go to CZY reward, could be changed by governance
        _allocPointForSwapReward = 2000; // 20% of reward will go to swap(wbnb, btcb, busd) reward, could be changed by governance
